...
3. **Hand Off Video Generation:** Do not use a local Omni Flash extension. Hand the base images, script, and detailed sound-effect prompts to the computer-use agent for native video generation.

## 3. Video Handoff (Computer-Use Agent)
Video generation is handed off to the computer-use agent running on the Mac.
